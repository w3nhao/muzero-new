...
class Trainer:
    ...
    def __init__(self, initial_checkpoint, config):
        ...
        if self.config.optimizer == "SGD":
            ...
            raise NotImplementedError(f"{self.config.optimizer} is not implemented. You can change the optimizer manually in trainer.py.")
    ...
    def update_weights(self, batch):
        ...
        for i in range(1, len(predictions)):
            ...
            priorities[:, i] = numpy.abs(pred_value_scalar - target_value_scalar[:, i]) \
                ** self.config.PER_alpha
